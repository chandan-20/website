      ...
      <div className="mt-8 text-center">
        <div className="inline-flex items-center space-x-6 p-4 rounded-lg border border-border" style={{ background: 'var(--gradient-card)' }}>
          <div className="flex items-center space-x-2">
            <div className="w-4 h-4 rounded-full" style={{ background: 'hsl(var(--accent-teal))' }}></div>
            <span className="text-sm font-medium" style={{ color: 'hsl(var(--primary-blue))' }}>Manufacturing & Shipping Locations</span>
          </div>
        </div>
      </div>
    </div>
